...
下列为 README 展示用截图，资源路径：`docs/images/`。
...
4. **接诊页面**
   ...
   ![接诊页面](docs/images/04-consultation.png)

   - *接诊与就诊相关业务在同一套权限体系下完成。*

5. **药品库存**

   ![药品库存](docs/images/05-inventory.png)

   - *药品与库存（含批次、效期等）集中管理。*

6. **角色权限**

   ![角色权限](docs/images/06-rbac-role.png)

   - *基于角色与菜单的访问控制，与业务菜单联动。*
